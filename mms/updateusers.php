...
" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    ...
    <body>
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <input type="text" placeholder="Search" aria_label="Search" class="form-control-dark w-50">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <form action="editusers.php" method="POST">
                        ...
                        <div class="form-floating">
                            <input type="email" class="form-control" id="floatingInput" placeholder="E-mail" name="email" value="<?php echo $user_data['email']?>">
