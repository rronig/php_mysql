...
// Check if the user already has a Tetris score
...
if ($stmt->num_rows > 0) {
    ...
    if ($score > $existing_score) {
        ...
        $update_sql = "UPDATE scores SET real_tetris = ? WHERE user_id = ?";
    ...
    $insert_sql = "INSERT INTO scores (real_tetris, user_id) VALUES (?, ?)";
